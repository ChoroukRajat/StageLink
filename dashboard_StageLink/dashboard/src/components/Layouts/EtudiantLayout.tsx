...
const menuGroup1 = [
    {
        ...
        menuItems: [

            {
                ...
                label: "Profile",
                route: "http://localhost:3000/role/Etudiant/profile",
            },
            {
                icon: (
                    <svg
                ...
                label: "Offres",
                route: "http://localhost:3000/role/Etudiant/offres"
            },

            {
                ...
                label: "Candidatures",
                route: "http://localhost:3000/role/Etudiant/candidatures"
            },
            {
                icon: (
                    <svg
                ...
                label: "Rapport",
                route: "http://localhost:3000/role/Etudiant/rapports"
            }
        ]
    }
];
    ...
    return (
        <>
            ...
            <div className="flex h-screen overflow-hidden">
                {/* <!-- ===== Sidebar Star ===== --> */}
                <Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} menuGroup={menuGroup1}/>
                {/* <!-- ===== Sidebar End ===== --> */}
