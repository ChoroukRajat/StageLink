...
const menuGroup1 = [
    {
        ...
        menuItems: [

            {
                ...
                label: "Profile",
                route: "http://localhost:3000/role/Encadrant/profile",
            },
            {
                icon: (
                    <svg
                ...
                label: "Candidatures",
                route: "http://localhost:3000/role/Encadrant/candidatures"
            }
            ,
            {
                icon: (
                ...
                label: "Statistics",
                route: "http://localhost:3000/role/Encadrant/dashboard"
            }
        ]
    }
];
